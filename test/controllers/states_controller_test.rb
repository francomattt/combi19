...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { deleted_at: @state.deleted_at, name: @state.name } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { deleted_at: @state.deleted_at, name: @state.name } }
