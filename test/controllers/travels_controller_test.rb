...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { combi_id: @travel.combi_id, state_id: @travel.state_id, travel_day: @travel.travel_day, travel_hour: @travel.travel_hour, way_id: @travel.way_id } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { combi_id: @travel.combi_id, state_id: @travel.state_id, travel_day: @travel.travel_day, travel_hour: @travel.travel_hour, way_id: @travel.way_id } }
