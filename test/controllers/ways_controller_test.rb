...
class WaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create way" do
    assert_difference('Way.count') do
      post ways_url, params: { way: { deleted_at: @way.deleted_at, description: @way.description, end: @way.end, start: @way.start } }
    end
  ...
  test "should update way" do
    patch way_url(@way), params: { way: { deleted_at: @way.deleted_at, description: @way.description, end: @way.end, start: @way.start } }
